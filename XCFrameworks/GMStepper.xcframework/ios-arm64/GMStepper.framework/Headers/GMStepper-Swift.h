...
#ifndef GMSTEPPER_SWIFT_H
#define GMSTEPPER_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="GMStepper",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
IB_DESIGNABLE
SWIFT_CLASS("_TtC9GMStepper9GMStepper")
...
@property (nonatomic) IBInspectable BOOL showIntegerIfDoubleIsInteger;
/// Text on the left button. Be sure that it fits in the button. Defaults to “−”.
@property (nonatomic, copy) IBInspectable NSString * _Nonnull leftButtonText;
/// Text on the right button. Be sure that it fits in the button. Defaults to “+”.
@property (nonatomic, copy) IBInspectable NSString * _Nonnull rightButtonText;
/// Text color of the buttons. Defaults to white.
@property (nonatomic, strong) IBInspectable UIColor * _Nonnull buttonsTextColor;
/// Background color of the buttons. Defaults to dark blue.
@property (nonatomic, strong) IBInspectable UIColor * _Nonnull buttonsBackgroundColor;
...
@property (nonatomic, strong) IBInspectable UIColor * _Nonnull labelTextColor;
/// Text color of the middle label. Defaults to lighter blue.
@property (nonatomic, strong) IBInspectable UIColor * _Nonnull labelBackgroundColor;
...
@property (nonatomic) IBInspectable CGFloat labelCornerRadius;
...
@property (nonatomic) IBInspectable CGFloat labelWidthWeight;
/// Color of the flashing animation on the buttons in case the value hit the limit.
@property (nonatomic, strong) IBInspectable UIColor * _Nonnull limitHitAnimationColor;
